                                            ...
                                            @if(in_array($intention_type->id, $selected_intention_types))
                                                ...
                                                @if((!empty($time_mass_intentions) && count($time_mass_intentions) > 0) || (!empty($prioritized_time_mass_intentions) && count($prioritized_time_mass_intentions) > 0))
                                                    ...
                                                    @php
                                                        ...
                                                        $next_priority = \App\Models\MassIntentionPriority::getNextPriority($intention_type->id,$request_time_option->id);
                                                                                ...
                                                                                <span class="text-sm text-black dark:text-neutral-200">
                                                                                    ...
                                                                                    <div class="max-w-sm space-y-3">
                                                                                        ...
                                                                                        @if(Auth::user()->can('mass_intention edit'))
                                                                                            ...
                                                                                            min="0" max="100"> --}}
                                                                                            @if( $mass_intention->mass_intention_priority != null && $mass_intention->mass_intention_priority > 0 )
                                                                                            <div class="flex flex-row">


                                                                                                <button type="button" wire:click="updatePriority({{ $mass_intention->id }}, 0,{{ $intention_type->id }},{{ $request_time_option->id }})" class="p-1 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" >
                                                                                                ...
                                                                                                <div class="flex flex-col">
                                                                                                    <button {{ $mass_intention->mass_intention_priority == 1 ? 'disabled' : '' }} type="button" wire:click="updatePriority({{ $mass_intention->id }}, {{ $mass_intention->mass_intention_priority - 1 }},{{ $intention_type->id }},{{ $request_time_option->id }} ,'move_up')" class="p-1 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" >
                                                                                                        ...
                                                                                                        <div class="hs-tooltip flex">
                                                                                                            ...
                                                                                                            <span class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity inline-block absolute invisible z-10 py-1 px-2 bg-gray-900 text-xs font-medium text-white rounded shadow-sm dark:bg-neutral-700" role="tooltip">
                                                                                                                Move priority up  {{ $mass_intention->id }},{{ $intention_type->id }},{{ $request_time_option->id }} ,{{ $mass_intention->mass_intention_priority - 1 }}
                                                                                                            </span>
                                                                                                        </div>
                                                                                                    ...
                                                                                                    <button {{ $mass_intention->mass_intention_priority == $next_priority - 1 ? 'disabled' : '' }} type="button" wire:click="updatePriority({{ $mass_intention->id }}, {{ $mass_intention->mass_intention_priority + 1 }},{{ $intention_type->id }},{{ $request_time_option->id }},'move_down')" class="p-1 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" >
                                                                                                        <div class="hs-tooltip flex">
                                                                                                            ...
                                                                                                            <span class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity inline-block absolute invisible z-10 py-1 px-2 bg-gray-900 text-xs font-medium text-white rounded shadow-sm dark:bg-neutral-700" role="tooltip">
                                                                                                                Move priority down {{ $mass_intention->mass_intention_priority + 1 }}
                                                                                                            </span>
                                                                                                        </div>
                                                                                                    ...
                                                                                                    <button type="button"  class="p-1 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                                                                                        {{ $mass_intention->mass_intention_priority ? $mass_intention->mass_intention_priority : 0 }}
                                                                                                    </button>

                                                                                            </div>

                                                                                            @else
                                                                                                <button type="button" wire:click="updatePriority({{ $mass_intention->id }},  {{ $next_priority }},{{ $intention_type->id }},{{ $request_time_option->id }})"   class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" >
                                                                                                    <div class="hs-tooltip flex">
