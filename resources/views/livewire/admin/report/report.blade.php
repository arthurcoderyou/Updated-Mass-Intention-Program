                                                ...
                                                @if((!empty($time_mass_intentions) && count($time_mass_intentions) > 0) || (!empty($prioritized_time_mass_intentions) && count($prioritized_time_mass_intentions) > 0))
                                                    ...
                                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                                        ...
                                                        <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                                                ...
                                                                @php
                                                                    $index = 1;
                                                                    $index_count = count( $prioritized_time_mass_intentions);
                                                                    $index_array = [];

                                                                    foreach ($prioritized_time_mass_intentions as $mass_intention) {
                                                                        $index_array[] = $mass_intention->priority;
                                                                    }
                                                                @endphp
                                                                                    ...
                                                                                    <div class="max-w-sm space-y-3">
                                                                                        ...
                                                                                        @if(Auth::user()->can('mass_intention edit'))
                                                                                            ...
                                                                                            <div class="flex flex-row">
                                                                                                ...
                                                                                                @php
                                                                                                    $move_up_priority_value = 0;
                                                                                                    //if it is not the last one
                                                                                                    if($index != 1){
                                                                                                        $move_up_priority_value = $index_array[$index - 2];
                                                                                                    }
                                                                                                @endphp
                                                                                                <div class="flex flex-col">
                                                                                                    <button {{ $index == 1 ? 'disabled' : '' }} type="button" wire:click="updatePriority({{ $mass_intention->id }}, {{  $move_up_priority_value }},{{ $intention_type->id }}, 'move_up')" class="p-1 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" >
                                                                                                    ...
                                                                                                    @php
                                                                                                        $move_down_priority_value = 0;
                                                                                                        //if it is not the last one
                                                                                                        if($index != $index_count){
                                                                                                            $move_down_priority_value = $index_array[$index];
                                                                                                        }
                                                                                                    @endphp
                                                                                                    <button {{ $index == $index_count ? 'disabled' : '' }} type="button" wire:click="updatePriority({{ $mass_intention->id }}, {{ $move_down_priority_value }},{{ $intention_type->id }},'move_down')" class="p-1 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" >
                                                                                                        <div class="hs-tooltip flex">
